    ...
    while True:
        ...
        try:
            ...
            if predict(imgWebcam, model, descriptor):
                ...
                imgAug=cv2.putText(imgWebcam, "Object has Found", (50, 50), cv2.FONT_HERSHEY_SIMPLEX,
                             1, (255, 0, 0), 2, cv2.LINE_AA)
                imgAug = cv2.bitwise_and(imgAug, imgAug, mask=maskInv)
                imgAug = cv2.bitwise_or(imgWarp, imgAug)
                
            else:
                imgAug=cv2.putText(imgWebcam, "Object wasn`t Found", (50, 50), cv2.FONT_HERSHEY_SIMPLEX,
                            1, (255, 0, 0), 2, cv2.LINE_AA)
        except:
            # print("Bad frame")
            pass  
